...
export async function seedConfigs() {
  ...
  const configsData = [
    ...
    },
    {
      ...
      value: 'true',
      name: '显示面包屑',
      description: '页面顶部是否展示面包屑导航，用户可在个人设置中覆盖',
      type: 'boolean',
      group: 'ui',
      status: CommonStatus.ENABLED,
      sort: 3,
    ...
    },
    {
      ...
      value: 'HH:mm:ss',
      name: '时间格式',
      description: '系统全局时间展示格式（24小时制）（全局控制，用户不可覆盖）',
      type: 'string',
      group: 'ui',
      status: CommonStatus.ENABLED,
      sort: 6,
    ...
    },
    {
      ...
      value: 'Asia/Shanghai',
      name: '默认时区',
      description: '系统默认时区，用户可在个人设置中覆盖',
      type: 'string',
      group: 'ui',
      status: CommonStatus.ENABLED,
      sort: 8,
    ...
    {
      key: 'ui.enableNotification',
      value: 'true',
      name: '默认启用通知',
      description: '新用户默认是否启用系统通知',
      type: 'boolean',
      group: 'ui',
      status: CommonStatus.ENABLED,
      sort: 9,
